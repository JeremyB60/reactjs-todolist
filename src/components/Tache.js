...
export default function Tache({ tacheInfo, onClick, onClick2, handleRename, handlePriorityChange }) {
    ...
    //affichage
    return (
        <StyledLi priorite={tacheInfo.priorité} className='list-group-item d-flex flex-wrap gap-1 justify-content-evenly align-items-center flex-column'>{tacheInfo.nom}
